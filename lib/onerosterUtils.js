...
var buildWhereStmt = function(req, res, tableFields, prefix, additionalStmts) {
  ...
  if (req.query.filter) {
    // Fix query fields based on references
    var filter = req.query.filter;
    filter = filter.replace(/class.sourcedId/g, "classSourcedId");
    filter = filter.replace(/course.sourcedId/g, "courseSourcedId");
    filter = filter.replace(/school.sourcedId/g, "schoolSourcedId");
    filter = filter.replace(/terms.sourcedId/g, "termSourcedId");
    filter = filter.replace(/user.sourcedId/g, "userSourcedId");
